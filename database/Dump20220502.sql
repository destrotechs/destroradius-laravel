...
--
-- Host: 127.0.0.1    Database: destroradius
-- ------------------------------------------------------
...
--
-- Table structure for table `custom_limits`
--

DROP TABLE IF EXISTS `custom_limits`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `custom_limits` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `limitname` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `limitmeasure` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pref_table` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `custom_limits`
--

LOCK TABLES `custom_limits` WRITE;
/*!40000 ALTER TABLE `custom_limits` DISABLE KEYS */;
INSERT INTO `custom_limits` VALUES (9,'Max-All-MB','1024100','check',':=',NULL,NULL,NULL),(10,'Max-All-MB','1024100','reply',':=',NULL,NULL,NULL),(11,'WISPr-Session-Terminate-Time','02-05-2022T13:00:00','reply',':=',NULL,NULL,NULL);
/*!40000 ALTER TABLE `custom_limits` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `customerpackages` WRITE;
/*!40000 ALTER TABLE `customerpackages` DISABLE KEYS */;
/*!40000 ALTER TABLE `customerpackages` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `customers` (
  ...
  `cleartextpassword` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
DROP TABLE IF EXISTS `managercommissionrates`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
LOCK TABLES `managercommissionrates` WRITE;
/*!40000 ALTER TABLE `managercommissionrates` DISABLE KEYS */;
/*!40000 ALTER TABLE `managercommissionrates` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `managertransactions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
LOCK TABLES `managertransactions` WRITE;
/*!40000 ALTER TABLE `managertransactions` DISABLE KEYS */;
/*!40000 ALTER TABLE `managertransactions` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `naszones` WRITE;
/*!40000 ALTER TABLE `naszones` DISABLE KEYS */;
INSERT INTO `naszones` VALUES (1,1,1,NULL,NULL);
/*!40000 ALTER TABLE `naszones` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `package_prices` VALUES (2,3,'KSH',100.00,'null',NULL,NULL),(3,5,'KSH',50.00,'null',NULL,NULL);
...
CREATE TABLE `packages` (
  ...
  `validdays` int DEFAULT NULL,
  `durationmeasure` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `packages_packagename_unique` (`packagename`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `payments` (
  ...
  `packagebought` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `settings` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `logs_enabled` int NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `supplies` VALUES (2,'MIkrotik','123 Main Street','1','mikrotik@mk.com','Juma K','0715266322',NULL,'2021-12-15 03:48:08','2021-12-15 03:48:08');
...
INSERT INTO `users` VALUES (3,'Admin One','admin@admin.com',NULL,'$2y$10$fDJk4zuGDOYYXQaJ7bcE4eQQODRwmSXOwHMSaSiY2eSA.bTLjk1bu',1,'0712345678','123 Main Street','Nairobi','jZEanulGNOpCvpVVyhetOMHheu4HRstdObAi4yz3Orc92hXngckTT5SuVE1D','2021-12-17 07:44:44','2021-12-17 07:44:44'),(4,'Manager One','manager@one.com',NULL,'$2y$10$fZJrfLVC2Zajo3Rn9V9FDe173ak82pDTuQZQyZa054Wb/4vvnoR1u',2,'0715266323','123 Main Street','Nairobi',NULL,'2021-12-17 08:11:46','2021-12-17 08:11:46');
...
CREATE TABLE `vendors` (
  ...
  `description` varchar(230) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `zonecustomers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `zonecustomers`
--

LOCK TABLES `zonecustomers` WRITE;
/*!40000 ALTER TABLE `zonecustomers` DISABLE KEYS */;
/*!40000 ALTER TABLE `zonecustomers` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `zonemanagers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
LOCK TABLES `zonemanagers` WRITE;
/*!40000 ALTER TABLE `zonemanagers` DISABLE KEYS */;
/*!40000 ALTER TABLE `zonemanagers` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-05-02 12:39:08
